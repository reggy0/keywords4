...
Original file is located at
    https://colab.research.google.com/drive/1hsmFMzgQK1V_ynvFgc9TuGsEurec7BKz
"""
...
import pickle
with open("happy_gen_model.pkl", "wb") as f:
    pickle.dump(happy_gen, f)

import shutil
shutil.copy("/content/happy_gen_model.pkl", "/content/drive/MyDrive/Pickle")

# load the saved model using Pickle
with open("/content/happy_gen_model.pkl", "rb") as f:
